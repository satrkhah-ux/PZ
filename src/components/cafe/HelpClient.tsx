...
const CASHIER: Section[] = [
  { q: "تسجيل الدخول", steps: ["افتح اختصار «كاشير بيزارا» على الجهاز.", "اسم المستخدم: aaa — كلمة المرور: 123."] },
  {
    q: "إصدار طلب من الكاشير",
    steps: [
      "اختر الأصناف من القائمة بالضغط على «إضافة».",
      "حدّد نوع الطلب: 🥡 خارجي أو 🏠 داخل المحل (ثم اختر رقم الطاولة).",
      "أضف الإضافات إن طلب الزبون (شوت، كراميل…): اكتب النوع والسعر واضغط +.",
      "أدخل خصماً إن وُجد.",
  ...
  },
  {
    ...
    steps: [
      ...
      "راجع الأصناف والملاحظة (سكر قليل…) على البطاقة.",
  ...
  },
  {
    ...
    steps: [
      "«المصروفات»: سجّل أي مصروف يومي (مشتريات، ثلج…) بالمبلغ والتصنيف.",
...
const ADMIN: Section[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "يظهر تطبيق «إدارة بيزارا» يفتح مباشرة على لوحة التحكم.",
    ],
  },
];
